...
mapa <- leaflet(data=data) %>%
  ...
  addCircleMarkers(lng=~Longitud, lat=~Latitud, popup=~Popup, color=~pal(Tipo.de.valor), opacity = 1, fillOpacity = 0.5, weight = 2, radius = 6, clusterOptions = markerClusterOptions(), group="Lugares") %>%
  # Añadir rutas
  ...
  # Add search button
  addSearchMarker('Lugares', position = 'topleft', propertyName = 'popup')
# Imprimir el mapa
mapa
